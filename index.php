...
<head>
    ...
    <script src="js/registrar_chamada.js" defer></script>

    <title>Lista de chamada PPI</title>
</head>
...
<body>
    ...
    <main class="container">
        <button  class="btn-padrao" data-toggle="modal" data-target="#chamada">Marcar Presença</button>
        <h2>Registro</h2>
